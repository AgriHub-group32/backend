...
let ChatController = class ChatController {
    ...
    createRoom(user, otherUserId) {
        return this.chatService.findOrCreateRoom(user.id, otherUserId);
    }
    getMessages(roomId, user, page, limit) {
        return this.chatService.getRoomMessages(roomId, user.id, page ? parseInt(page) : 1, limit ? parseInt(limit) : 50);
    }
};
